  ...
  return (
    <div className="sidebar-container prose">
      ...
      <p>
        ...
        and{" "}
        <a target="_blank" href="https://gtfs.org/" className="link">
          GTFS
        </a>{" "}
        csv files converted to{" "}
        <a target="_blank" href="https://parquet.apache.org/" className="link">
          parquet
        </a>{" "}
        format and served over HTTP. Parquet files are imported in the database
        by registering urls and SQL queries are completed in the browser. Select
        a <code className="txt-code">route</code> and{" "}
        <code className="txt-code">shape_id</code> below.
      </p>
      <p>
        Check out the github repo:{" "}
        <a
          target="_blank"
          href="https://github.com/smohiudd/gtfs-parquet-duckdb-wasm"
          className="link"
        >
          https://github.com/smohiudd/gtfs-parquet-duckdb-wasm
        </a>{" "}
        and the{" "}
        <a
          target="_blank"
          href="https://saadiqm.com/2023/09/26/gtfs-parquet-duckdb.html"
          className="link"
        >
          blog post
        </a>
      ...
      <div class="flex flex--column">
        <span>
          <div className="select-container py12">
            <div className={`${props.loadingTrips} loading--s mr6`}></div>
            <select
        ...
        <div className="select-container mb18">
          <div className={`${props.loadingShapes} loading--s mr6`}></div>
          <select
            className="select select--stroke color-red"
